...
export const PromoV6: React.FC = () => {
  ...
  return (
    <AbsoluteFill>
      ...
      {/* Typing during ingest terminal (~frame 370) — real keyboard recording */}
      <SFX src="audio/pro-typing-mech-individual.mp3" at={370} volume={0.2} duration={120} />
      ...
      {/* Typing during query terminal (~frame 1045) — real keyboard recording */}
      <SFX src="audio/pro-typing-mech-individual.mp3" at={1045} volume={0.2} duration={120} />
