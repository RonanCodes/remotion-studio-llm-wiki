...
const IngestDemo: React.FC = () => {
  ...
  const badges = [
    { label: "Web", color: light.cyan, x: -720, y: -160, delay: 140 },
    { label: "YouTube", color: "#FF0000", x: 720, y: -130, delay: 155 },
    { label: "PDF", color: light.green, x: -700, y: 20, delay: 170 },
    { label: "GitHub", color: light.textPrimary, x: 700, y: 50, delay: 185 },
    { label: "Reddit", color: "#FF4500", x: -680, y: 200, delay: 200 },
  ];
...
const CTA: React.FC = () => {
  ...
  const logoData = [
    { src: staticFile("assets/logos/claude-ai-icon.svg"), delay: 60 },
    { src: staticFile("assets/logos/obsidian-logo-gradient.svg"), delay: 72 },
    { src: staticFile("assets/logos/github-mark.svg"), delay: 84 },
  ];
        ...
        <div style={{ display: "flex", gap: 40, marginTop: 50 }}>
          {logoData.map((logo, i) => {
            ...
            return (
              ...
              >
                <Img src={logo.src} style={{ width: 36, height: 36 }} />
              </div>
            );
          })}
        </div>
...
// ---------------------------------------------------------------------------
export const PromoV3Synth: React.FC = () => {
  ...
  return (
    <AbsoluteFill>
      {/* ====== BACKGROUND MUSIC — Synthwave Tech ====== */}
      <Audio
        src={staticFile("audio/music-synthwave-tech.mp3")}
        volume={(f) => {
          // Fade in over 2s (60 frames)
          if (f < 60) return interpolate(f, [0, 60], [0, 0.2]);
      ...
      {/* Whoosh on hook entrance */}
      <SFX src="audio/whoosh-swoosh-1.mp3" at={0} volume={0.2} />

      {/* Whoosh on scene transitions */}
      <SFX src="audio/whoosh-swoosh-3.mp3" at={105} volume={0.15} />
      <SFX src="audio/whoosh-swoosh-1.mp3" at={240} volume={0.15} />

      {/* Power-up on LLM Wiki reveal */}
      <SFX src="audio/sfx-powerUp3.mp3" at={242} volume={0.18} />

      {/* Whoosh into terminal scene */}
      <SFX src="audio/whoosh-swoosh-3.mp3" at={375} volume={0.15} />

      {/* Typing clicks during ingest terminal (every ~25 frames) */}
      <SFX src="audio/sfx-click_003.mp3" at={385} volume={0.12} />
      <SFX src="audio/sfx-click_004.mp3" at={410} volume={0.1} />
      <SFX src="audio/sfx-click_005.mp3" at={435} volume={0.12} />
      <SFX src="audio/sfx-click_003.mp3" at={460} volume={0.1} />
      <SFX src="audio/sfx-click_004.mp3" at={485} volume={0.12} />

      {/* Confirmation sounds on terminal output lines */}
      <SFX src="audio/sfx-confirmation_001.mp3" at={510} volume={0.1} />
      <SFX src="audio/sfx-confirmation_002.mp3" at={520} volume={0.1} />
      <SFX src="audio/sfx-confirmation_003.mp3" at={530} volume={0.1} />

      {/* Badge pop sounds */}
      <SFX src="audio/sfx-pepSound1.mp3" at={515} volume={0.1} />
      <SFX src="audio/sfx-pepSound2.mp3" at={530} volume={0.1} />
      <SFX src="audio/sfx-pepSound3.mp3" at={545} volume={0.1} />
      <SFX src="audio/sfx-pepSound4.mp3" at={560} volume={0.1} />
      <SFX src="audio/sfx-pepSound5.mp3" at={575} volume={0.1} />

      {/* Whoosh into wiki output */}
      <SFX src="audio/whoosh-swoosh-1.mp3" at={630} volume={0.15} />

      {/* Whoosh into graph scene */}
      <SFX src="audio/whoosh-swoosh-3.mp3" at={825} volume={0.15} />

      {/* Node pop sounds during graph building (every 8 frames x 12 nodes) */}
      {NODE_POSITIONS.map((_, i) => (
        <SFX
          key={`node-sfx-${i}`}
          src={`audio/sfx-pepSound${(i % 5) + 1}.mp3`}
          at={845 + i * 8}
          volume={0.08}
        />
      ))}

      {/* Counter phase change sounds */}
      <SFX src="audio/sfx-highUp.mp3" at={875} volume={0.12} />
      <SFX src="audio/sfx-highUp.mp3" at={925} volume={0.15} />

      {/* Whoosh into query */}
      <SFX src="audio/whoosh-swoosh-1.mp3" at={1050} volume={0.15} />

      {/* Typing clicks during query terminal */}
      <SFX src="audio/sfx-click_005.mp3" at={1060} volume={0.12} />
      <SFX src="audio/sfx-click_003.mp3" at={1085} volume={0.1} />
      <SFX src="audio/sfx-click_004.mp3" at={1110} volume={0.12} />
      <SFX src="audio/sfx-click_005.mp3" at={1135} volume={0.1} />
      <SFX src="audio/sfx-click_003.mp3" at={1160} volume={0.12} />

      {/* Query result confirmation */}
      <SFX src="audio/sfx-confirmation_004.mp3" at={1200} volume={0.1} />

      {/* Whoosh into CTA */}
      <SFX src="audio/whoosh-swoosh-3.mp3" at={1275} volume={0.18} />

      {/* Success chime on CTA */}
      <SFX src="audio/chime-success.mp3" at={1280} volume={0.15} />
