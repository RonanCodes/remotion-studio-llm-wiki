...
export const PromoV4: React.FC = () => {
  ...
  return (
    <AbsoluteFill>
      ...
      {/* Typing during ingest terminal (~frame 375) — start right with the scene */}
      <SFX src="audio/typing-burst.mp3" at={376} volume={0.18} />
      <SFX src="audio/typing-long.mp3" at={400} volume={0.16} />
      <SFX src="audio/typing-burst.mp3" at={445} volume={0.18} />

      {/* Subtle appear on terminal output lines */}
      <SFX src="audio/sfx-appear.mp3" at={505} volume={0.08} />
      <SFX src="audio/sfx-appear.mp3" at={515} volume={0.08} />
      <SFX src="audio/sfx-appear.mp3" at={525} volume={0.08} />

      {/* Node bell sounds during graph building — gentle chime per node */}
      {NODE_POSITIONS.map((_, i) => (
        <SFX
          key={`node-sfx-${i}`}
          src="audio/sfx-node-bell.mp3"
          at={845 + i * 8}
          volume={0.1}
        />
      ))}

      {/* Typing during query terminal (~frame 1050) — start right with the scene */}
      <SFX src="audio/typing-long.mp3" at={1051} volume={0.18} />
      <SFX src="audio/typing-burst.mp3" at={1095} volume={0.16} />
      <SFX src="audio/typing-long.mp3" at={1135} volume={0.18} />
